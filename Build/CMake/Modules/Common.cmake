...
FUNCTION(DOWNLOAD_DEPENDENCY_INTERNAL RELATIVE_PATH FILE_ID FROM_URL FROM_GIT)
	...
	IF(REDOWNLOAD)
		IF("$ENV{USE_LOCAL_DEPENDENCIES}" STREQUAL "1")
			...
			IF(RECLONE)
				...
				SET(GIT_CLONE "git clone ${FROM_GIT} ${DEPENDENCIES_REPO_PATH}")
		...
		ELSE()
			SET(URL "${FROM_URL}/${DEPENDENCIES_COMMIT_ID}/${RELATIVE_PATH}")
...
FUNCTION(DOWNLOAD_DEPENDENCY RELATIVE_PATH FILE_ID)
	DOWNLOAD_DEPENDENCY_INTERNAL(${RELATIVE_PATH} ${FILE_ID} "https://raw.githubusercontent.com/gongminmin/KlayGEDependencies",
		"https://github.com/gongminmin/KlayGEDependencies.git")
ENDFUNCTION()

FUNCTION(DOWNLOAD_DEPENDENCY_TOM RELATIVE_PATH FILE_ID)
	DOWNLOAD_DEPENDENCY_INTERNAL(${RELATIVE_PATH} ${FILE_ID} "https://raw.githubusercontent.com/unrealTOM/KlayGEDependencies",
		"https://github.com/unrealTOM/KlayGEDependencies.git")
ENDFUNCTION()
